...
public class Cloud : MonoBehaviour
{
    ...
    void Start()
    {
        gameManager = GameObject.Find("GameManager").GetComponent<GameManager>(); //look at heirarchy get the game manager object and get the script thats on it
        //search by tag, or layer, or by children
